...
private void __loadGraphData() {
  ...
  Function<String,Vertex> importer_v_func = (id) -> {
...
private void __saveGraphData() {
  ...
  Function<Vertex,String> exporter_v_func = (vertex) -> {
  ...
  public void __showFM(boolean raw) {
    ...
    //Graph<Vertex, Edge> subgraph = new AsSubgraph<>(graph, vertices, edges); notwork
    ...
    vertexList.forEach(
        vertex -> {
          ...
          Set<Edge> incoming_Edges = subgraph2.incomingEdgesOf(vertex);
